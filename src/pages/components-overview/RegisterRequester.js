...
const RegisterRequester = () => {
  ...
  useEffect(() => {
    if (itemId) {
      const fetchData = async () => {
        try {
          const response = await fetch(`http://191.252.212.69:3001/api/solicitante/${itemId}`);
  ...
  const handleSave = async () => {
    ...
    const url = itemId
      ? `http://191.252.212.69:3001/api/solicitante/${itemId}`
      : 'http://191.252.212.69:3001/api/solicitante';
